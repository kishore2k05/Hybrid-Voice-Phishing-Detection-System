...
const SAMPLES = {
  ...
  safe: `Hi, this is Amirah calling from Maybank customer service. I'm following up on your recent loan application submitted on the 12th. Our team has reviewed your documents and everything looks good. I just need to confirm a few details — your employment status and monthly income — so we can proceed with the approval. Is this a good time to talk?`,
};
...
const RECENT_ACTIVITY = [
  { id: "r1", icon: "⚠️", level: "danger", name: "Unknown +60 11-XXX-4521", time: "Today · 2:34 PM", badge: "SCAM", title: "Scam Detected", desc: "This transcript contains urgent financial pressure tactics, impersonation of bank officials, and requests for account credentials.", scam: 92, warn: 5, safe: 3 },
  { id: "r2", icon: "🔍", level: "warn", name: "Survey Call · 03-XXX-8800", time: "Today · 11:07 AM", badge: "SUSPICIOUS", title: "Slightly Suspicious", desc: "The transcript shows some pressure tactics but lacks strong indicators of fraud. Proceed with caution.", scam: 12, warn: 76, safe: 12 },
  { id: "r3", icon: "✅", level: "safe", name: "Maybank · 1300-XXX-888", time: "Yesterday · 9:45 AM", badge: "SAFE", title: "Call is Safe", desc: "No scam indicators detected. The conversation appears to be from a legitimate source.", scam: 2, warn: 4, safe: 94 },
];

const HISTORY_ITEMS = [
  { id: "h1", type: "attack", icon: "🔄", level: "danger", name: "Call Redirection Blocked", time: "Today · 3:15 PM", typeBadge: "CALL REDIRECT", typeBadgeClass: "call-redirect", badge: "BLOCKED", title: "Call Redirection Blocked", desc: "SENTRY detected outgoing call 010-1234-1234 was silently redirected to 010-9090-0909 by a vishing app. SIGNALLER alerted user immediately.", scam: 96, warn: 3, safe: 1 },
  { id: "h2", type: "attack", icon: "🖥️", level: "danger", name: "Display Overlay Attack", time: "Today · 2:34 PM", typeBadge: "DISPLAY OVERLAY", typeBadgeClass: "display-overlay", badge: "BLOCKED", title: "Display Overlay Detected", desc: "OCR extracted 010-1234-1234 from screen but actual incoming number was 010-9090-0909. Fake UI overlay was covering the real caller ID.", scam: 94, warn: 4, safe: 2 },
  { id: "h3", type: "attack", icon: "👥", level: "warn", name: "Duplicate Contact Removed", time: "Today · 1:02 PM", typeBadge: "DUP CONTACT", typeBadgeClass: "dup-contact", badge: "REMOVED", title: "Duplicate Contact Removed", desc: 'Attacker registered phone number 010-9090-0909 under contact name "Mom". SENTRY flagged it as not present in call/SMS history whitelist.', scam: 20, warn: 75, safe: 5 },
  { id: "h4", type: "scan", icon: "⚠️", level: "danger", name: "Unknown +60 11-XXX-4521", time: "Today · 2:34 PM", typeBadge: "VISHING", typeBadgeClass: "vishing", badge: "SCAM", title: "Scam Detected", desc: "This transcript contains urgent financial pressure tactics, impersonation of bank officials, and requests for account credentials.", scam: 92, warn: 5, safe: 3 },
  { id: "h5", type: "scan", icon: "🔍", level: "warn", name: "Survey Call · 03-XXX-8800", time: "Today · 11:07 AM", typeBadge: "SUSPICIOUS", typeBadgeClass: "display-overlay", badge: "WARN", title: "Slightly Suspicious", desc: "The transcript shows some pressure tactics but lacks strong indicators of fraud. Proceed with caution.", scam: 12, warn: 76, safe: 12 },
  { id: "h6", type: "safe", icon: "✅", level: "safe", name: "Maybank · 1300-XXX-888", time: "Yesterday · 9:45 AM", typeBadge: "SAFE", typeBadgeClass: "safe", badge: "SAFE", title: "Call is Safe", desc: "No scam indicators detected. The conversation appears to be from a legitimate source.", scam: 2, warn: 4, safe: 94 },
  { id: "h7", type: "safe", icon: "📞", level: "safe", name: "Outgoing · 03-8888-9999", time: "Yesterday · 4:22 PM", typeBadge: "SAFE CALL", typeBadgeClass: "safe", badge: "SAFE", title: "Call is Safe", desc: "Outgoing call number matched the connected number. No overlay detected by OCR comparison.", scam: 1, warn: 3, safe: 96 },
];

const PERMISSIONS = [
  { granted: true, name: "READ_CONTACTS", desc: "Dup contacts scan" },
  { granted: true, name: "READ_SMS", desc: "Build whitelist" },
  { granted: true, name: "READ_CALL_LOG", desc: "Whitelist + redirection" },
  { granted: true, name: "READ_PHONE_STATE", desc: "Call state monitoring" },
  { granted: true, name: "READ_PHONE_NUMBER", desc: "API level 29+ required" },
  { granted: true, name: "FOREGROUND_SERVICE", desc: "Background monitoring" },
  { granted: false, name: "WRITE_CONTACTS", desc: "Delete dup contacts" },
];

const ALGO_STEPS = [
  { text: "Scan contacts", desc: "build a hash map of names → phone number lists" },
  { text: "Find duplicates", desc: "flag any name mapped to more than one number" },
  { text: "Build whitelist", desc: "collect all numbers from recent call log & SMS history" },
  { text: "Filter whitelist", desc: "remove duplicates whose numbers appear in history (trusted)" },
